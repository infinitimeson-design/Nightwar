    ...
    function render(){
        ...
        slideEls.forEach((el, i)=>{
            ...
            if(abs === 0){
                ...
                transform = `translateX(${dir * 62}%) translateZ(-140px) rotateY(${-dir * 38}deg) scale(.76)`;
                opacity   = .6;
                ...
                transform = `translateX(${dir * 106}%) translateZ(-280px) rotateY(${-dir * 46}deg) scale(.58)`;
                opacity   = .3;
                filter    = "brightness(.4)";
                zIndex    = 10;
                ...
                transform = `translateX(${dir * 136}%) translateZ(-360px) rotateY(${-dir * 50}deg) scale(.48)`;
                opacity   = 0;
                filter    = "brightness(.3)";
                zIndex    = 0;
